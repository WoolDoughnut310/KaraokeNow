System.register(['jotai/vanilla/utils', 'jotai', 'react'], (function (exports) {
  'use strict';
  var RESET, unstable_NO_STORAGE_VALUE, atom, SECRET_INTERNAL_getScopeContext, useAtom, useSetAtom, SECRET_INTERNAL_registerPromiseAbort, useContext, useCallback, useMemo;
  return {
    setters: [function (module) {
      RESET = module.RESET;
      unstable_NO_STORAGE_VALUE = module.unstable_NO_STORAGE_VALUE;
      exports({ RESET: module.RESET, unstable_NO_STORAGE_VALUE: module.unstable_NO_STORAGE_VALUE });
    }, function (module) {
      atom = module.atom;
